...
function AyudaEstrategica() {
  ...
  const info = [
    {
      titulo1:
        "Historia de Éxito: LatamStore, de un negocio local a un gigante del e-commerce en Latinoamérica",
      parrafo1:
        "Con el apoyo de growthsuite, LatamStore evolucionó de un pequeño negocio familiar a una plataforma de e-commerce a gran escala, ofreciendo una experiencia de usuario excepcional y un sistema de ventas automatizado que transformó por completo sus operaciones.",
      imagen1:
        "https://imagenesrutalab.s3.us-east-1.amazonaws.com/growthsuite/CASOSEXITOSOS/casosExitosos.png",
      titulo2: "Tecnología y Estrategia para Conquistar Nuevos Mercados",
      parrafo2:
        "Gracias a nuestra plataforma integral, LatamStore logró expandir sus ventas a distintos países de Latinoamérica en tiempo récord, optimizando la logística, automatizando la gestión de inventarios y brindando soporte 24/7 a sus clientes.",
      imagen2:
        "https://imagenesrutalab.s3.us-east-1.amazonaws.com/growthsuite/CASOSEXITOSOS/GROWTHIA.jpg",
      titulorazones:
        "3 CLAVES QUE CONVIRTIERON A LATAMSTORE EN UN LÍDER DEL E-COMMERCE REGIONAL",
      razon1: "Expansión Internacional sin Fricciones",
      parraforazon1:
        "Implementamos una infraestructura que permite a LatamStore procesar pagos en múltiples monedas y despachar pedidos a distintos países de América Latina sin retrasos ni complicaciones.",
      razon2: "Automatización de Ventas y Atención al Cliente",
      parraforazon2:
        "Con nuestra tecnología, un negocio local se transformó en una plataforma de e-commerce a gran escala, ofreciendo una excelente experiencia de usuario y un sistema de ventas automatizado.",
      razon3: "Estrategia de Marketing Digital y Crecimiento Acelerado",
      parraforazon3:
        "Diseñamos campañas segmentadas para alcanzar públicos específicos en cada mercado, aplicando técnicas de growth hacking para posicionar a LatamStore rápidamente en los primeros lugares de venta online.",
      titulo3: "Preparados para un Futuro Sin Límites",
      parrafo3:
        "El nuevo ecosistema de LatamStore no solo se beneficia de procesos operativos ágiles y confiables, sino que también se encuentra listo para escalar a cualquier mercado que desee, impulsando su marca por toda Latinoamérica.",
      imagen3:
        "https://imagenesrutalab.s3.us-east-1.amazonaws.com/growthsuite/casosestudio/growth-suite-3d.jpg",
      titulo4:
        "¿Te imaginas duplicar o triplicar tus ventas con la estrategia correcta? Descubre cómo growthsuite puede convertir tu negocio en el próximo caso de éxito en el e-commerce regional.",
    },
  ];
